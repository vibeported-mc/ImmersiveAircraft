...
public class VehicleScreen extends AbstractContainerScreen<VehicleScreenHandler> {
    ...
    public VehicleScreen(VehicleScreenHandler handler, Inventory inventory, Component title) {
        super(handler, inventory, title, DEFAULT_IMAGE_WIDTH, BASE_HEIGHT + handler.getVehicle().getInventoryDescription().getHeight() + TITLE_HEIGHT * 2);
    ...
    @Override
    protected void extractTooltip(@NotNull GuiGraphicsExtractor context, int mouseX, int mouseY) {
        // Slot tooltip
